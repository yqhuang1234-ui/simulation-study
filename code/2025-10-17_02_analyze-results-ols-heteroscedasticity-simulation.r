...
fits_file <- '/data/2025-10-18_log-linear-fits_ols-heteroscedasticity-simulation_n100_reps1000_seed1234_c0-1-10-200.rds'
...
## ================================
table_save <- paste0(save_results_path,"/01_log-linear-table-simulation-results-mcse_",param_data,'.png')
save_kable(tbl, table_save , zoom = 4, vwidth = 1000, vheight = 1200)
plot_save <- paste0(save_results_path,"/02_log-linear-plots-simulation-results-mcse_",param_data,'.png')
